...
TIC TAC TOE GAME
UPDATES: 
tab is now a global variable
tab is a simple array (not a matrix)
AI optimization: alpha-beta pruning
function 'insert' optimized
functions 'max' and 'min' added
*/
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
